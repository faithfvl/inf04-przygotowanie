# Przygotowanie do egzaminu INF.04

Repozytorium z moimi materiałami, projektami i rozwiązaniami zadań przygotowujące do kwalifikacji **INF.04 – Projektowanie, programowanie i testowanie aplikacji** (technik programista).
